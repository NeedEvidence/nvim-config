...
vim.keymap.set("n","<leader>go", ":lua Snacks.gitbrowse.open()<CR>", {desc = "open git repository in browser", silent = true})
vim.keymap.set("n","<leader>sf", ":lua Snacks.picker.pick('files')<CR>", {desc = "file picker", silent = true})
vim.keymap.set("n","<leader>sg",":lua Snacks.picker.pick('grep')<CR>", {desc = "grep picker", silent = true})
vim.keymap.set("n","<leader>u",":lua Snacks.picker.pick('undo')<CR>", {desc = "undo tree", silent = true})
vim.keymap.set("n","<leader><leader>",":lua Snacks.picker.pick('buffers')<CR>", {desc = "open buffers", silent = true})
